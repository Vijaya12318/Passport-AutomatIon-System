...
$email=$_POST['email'];
$sql="select * from online_passport.personal_details where email='$email'";
...
$email=$_POST['email'];
$sql="select * from online_passport.other_details where email='$email'";
$result=mysqli_query($conn,$sql);
if(mysqli_num_rows($result)>0)
{
...
$email=$_POST['email'];
$sql="select * from online_passport.references where email='$email'";
$result=mysqli_query($conn,$sql);
if(mysqli_num_rows($result)>0)
{
...
$email=$_POST['email'];
$sql="select * from online_passport.appointment_details where email='$email'";
$result=mysqli_query($conn,$sql);
if(mysqli_num_rows($result)>0)
{
...
I agree to the terms and conditions issued by the Government of India.
</p>
<a href="login.php">LOGOUT</a>
</PRE>
</FORM>
<a href="verify_status.php">verify status</a>
</body>
</html>
